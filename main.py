...
async def start(message : types.Message):
        ...
        if result ==[]:
            ...
            inline_kb1 = InlineKeyboardButton('Отправить номер', callback_data='contact')
            inline_kb2 = InlineKeyboardButton('Отправить локацию', callback_data='location')
            inline_kb3 = InlineKeyboardButton('Заказать еду', callback_data= 'food')
